namespace NetScriptFramework
{
    ...
    public static class Main
    {
        ...
        /// </summary>
        public static readonly int FrameworkVersion = 10;
        ...
        /// </summary>
        internal static Assembly FrameworkAssembly { get; private set; }

        /// <summary>
        ///     Gets the game instance. This will contain type implementations and interfaces. If no valid game instance is found
        ///     this will be null, plugins may still be loaded into an unknown process.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        ///     Gets the game version library. This will contain information about types, offsets, functions. If no version
        ///     information is loaded it will be null and we will not be able to provide
        ...
        /// </value>
        public static LogFile Log { get; private set; }
        ...
        public static void CriticalException(string message, bool kill)
        {
            ...
            RTHandler.SuspendAllThreadsInCurrentProcess();

            MessageBox.Show(message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);

            RTHandler.ExitProcess(!kill);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static long GenerateGuid() => IDGenerator.Generate();
        ...
        public sealed class FrameworkInitializationParameters
        {
            ...
            /// <summary>
            ///     Gets or sets the delayed initialize. If this is greater than zero it will create a new thread that will initialize
        ...
        /// <summary>
        ///     Writes the native crash log for specified context. It does not actually treat this as a crash, it just writes out
        ///     to file as if this was a crash.
        ///     Warning: plugins may still treat this as a crash and modify registers or perform functions that would happen on
        ///     crash!
        /// </summary>
        /// <param name="cpu">The cpu context.</param>
        ...
        /// </summary>
        internal static int _is_initializing_plugin { get; set; }
        ...
        ///     Has debug listeners.
        /// </summary>
        private static int HasDebugListeners;
        ...
        /// </summary>
        internal static int GameCreate;

        /// <summary>
        ///     The identifier generator.
        /// </summary>
        private static UIDGenerator IDGenerator;

        /// <summary>
        ///     Initializes the log file.
        /// </summary>
        private static void InitializeLog() => Log = new LogFile();
        ...
        /// </summary>
        private static FileInfo VersionLibraryFile;
