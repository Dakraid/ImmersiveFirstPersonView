namespace NetScriptFramework
{
    ...
    public sealed class GameInfo
    {
        ...
        ///     The types.
        /// </value>
        public IReadOnlyList<GameTypeInfo> Types => this.typesList;
        ...
        ///     The globals.
        /// </value>
        public IReadOnlyList<GameGlobalInfo> Globals => this.globalsList;
        ...
        ///     The functions.
        /// </value>
        public IReadOnlyList<GameFunctionInfo> Functions => this.functionsList;
        ...
        ///     The cached values.
        /// </value>
        public IReadOnlyList<int?> CachedValues => this.cachedValues;
        ...
        internal void ReadFromFile(FileInfo file, int isLoadingAlias)
        {
            this.Clear();
        ...
        /// </summary>
        /// <param name="file">The file.</param>
        internal void WriteToFile(FileInfo file)
        {
        ...
        private void ReadFromStream(BinaryReader stream, FileInfo info, int isLoadingAlias)
        {
            ...
            if (stream.ReadByte() != 0)
            {
                ...
                var oldPart = string.Join("_", this.FileVersion);
        ...
        /// </summary>
        /// <param name="stream">The stream.</param>
        private void WriteToStream(BinaryWriter stream)
        {
        ...
        public sealed class GameFieldInfo
        {
            ...
            /// <summary>
            ///     Gets the field identifier. This is not the same as global unique identifier. Fields in different types can have the
            ///     same identifier.
            /// </summary>
            /// <value>
            ...
            internal void WriteToStream(BinaryWriter stream)
            {
                ...
                else { stream.Write(this.FieldId); }
            }
        }
        ...
        /// <summary>
        ///     Tries to get the address of the specified object by its version independent identifier. This will return null if
