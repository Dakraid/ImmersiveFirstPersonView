namespace NetScriptFramework
{
    ...
    public abstract class MemoryObject : IMemoryObject, IArgument
    {
        ...
        /// <summary>
        ///     Returns true if memory object is valid and can be accessed for reading. It is possible for this to return true even
        ///     if
        ///     the object is not actually valid in case of bad pointers to valid memory regions, invalid cast or partially freed
        ///     memory!
        /// </summary>
        /// <value>
        ...
        /// </value>
        public GameInfo.GameTypeInstanceInfo TypeInfo => this.TypeInfos[0];
        ...
        ///     virtual function table or the virtual function table is itself zero.
        /// </summary>
        ...
        /// <summary>
        ///     Determines whether the specified <see cref="NetScriptFramework.IMemoryObject" />, is equal to this instance. If the
        ///     specified object
        ...
        /// <returns>
        ///     <c>true</c> if the specified <see cref="NetScriptFramework.IMemoryObject" /> is equal to this instance; otherwise,
        ///     <c>false</c>.
        /// </returns>
        ...
        public IArgument ParseArgument(string key, Message message, Parser parser)
        {
            ...
            return prop.GetMethod.Invoke(instance, new object[0]) as IArgument;
        }
