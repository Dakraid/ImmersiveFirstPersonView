namespace NetScriptFramework
{
    ...
    public sealed class MemoryParser
    {
        ...
        ///     The modules.
        /// </summary>
        private readonly List<KeyValuePair<string, IntPtr>> Modules = new List<KeyValuePair<string, IntPtr>>();
        ...
        private abstract class Statement
        {
            ...
            /// <summary>
            ///     Processes the statement with specified cpu context. Returns false if we couldn't read due to invalid memory
            ///     address.
            /// </summary>
            /// <param name="cpu">The cpu.</param>
            /// <param name="parent">The parent.</param>
        ...
        private sealed class StatementRegister : Statement
        {
            ...
            /// </summary>
            private static readonly Tuple<string, Func<CPURegisters, IntPtr>>[] Registers =
            {
            ...
            /// </summary>
            private Func<CPURegisters, IntPtr> Func;
        ...
        private abstract class StatementBlock : Statement
        {
            ...
            /// </summary>
            internal Statement One;

            /// <summary>
            ///     The parent, this may be null if root.
            /// </summary>
            internal StatementBlock Parent;
            ...
            private void ImplementOperators()
            {
                while (true)
                {
                    ...
                    var operand1 = this.Statements[bestIndex - 1];
        ...
        private sealed class StatementOperatorImpl : Statement
        {
            ...
            internal override bool Process(CPURegisters cpu, StatementBlock parent, List<IntPtr> stack)
            {
                ...
                var result = this.Operator.Func(op1, op2_t);
                stack.Add(result);
                return true;
            }
        }
        ...
        /// </summary>
        /// <seealso cref="NetScriptFramework.MemoryParser.Statement" />
        private sealed class StatementModule : Statement
        {
            /// <summary>
            ///     The value.
            /// </summary>
