...
#region Plugin class
    ...
    #region Plugin members
        ...
        ///     <para></para>
        ///     <para></para>
        ///     For developers: Other plugins may query plugin
        ...
        ///     <para></para>
        ///     <para></para>
        ///     For developers: This is what will be shown to user and in
        ...
        ///     <para></para>
        ///     <para></para>
        ///     For developers: Current version of your plugin. It is
        ...
        /// <summary>
        ///     Gets the author's name of plugin.
        ///     <para></para>
        ///     <para></para>
        ///     For developers: Set author's name or nickname here.
        ...
        /// <summary>
        ///     Gets the website of plugin.
        ///     <para></para>
        ///     <para></para>
        ///     For developers: Set website of your plugin here. This is where
        ///     users could check for newer versions or get support in case of issues. It is optional and the default value will
        ///     return
        ...
        /// </summary>
        /// <param name="loadedAny">
        ///     If set to <c>true</c> then we did load at least one plugin last pass. It is safe
        ///     to return false now and try again next pass. If this is set to <c>false</c> then all plugins in the last pass
        ///     also returned false and if that happens again the game will close with an error.
        /// </param>
        /// <returns></returns>
        protected virtual bool Initialize(bool loadedAny) => true;
        ...
        /// <summary>
        ///     Called when detaching from thread. This is used mostly only to clean up stuff from memory if you used thread-local
        ///     storage.
        /// </summary>
        ...
        internal void _onDetachThread() => this.OnDetachThread();
    ...
    #region Internal members
        ...
        internal string GetInternalString()
        {
            ...
            catch { return "ERROR<" + this.GetType().Name + ">"; }
        }
