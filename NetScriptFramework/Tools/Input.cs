...
namespace NetScriptFramework.Tools
{
    ...
    public static class Input
    {
        ...
        /// <returns></returns>
        public static bool IsPressed(VirtualKeys key) { return (GetAsyncKeyState((int) key) & 0x8000) != 0; }
        ...
        /// <param name="key">The key.</param>
        /// <returns></returns>
        public static bool IsToggled(VirtualKeys key) { return (GetAsyncKeyState((int) key) & 1) != 0; }
