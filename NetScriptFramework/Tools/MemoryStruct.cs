namespace NetScriptFramework.Tools
{
    ...
    /// <summary>
    ///     This class can be used to allocate a temporary struct. By default when allocated all data is zeroed out, fill out
    ///     the data using the index accessor where
    ...
    public sealed class MemoryStruct : TemporaryObject
    {
        ...
        /// </summary>
        internal MemoryAllocation Allocation;
        ...
        ///     The address.
        /// </value>
        public IntPtr Address => this.Allocation.Address;
        ...
        /// <summary>
        ///     Sets the value in this struct but doesn't set if it would conflict with any other value offsets that have been set
        ///     so far in which case it returns false instead. If there was exact same type of
        ...
        /// <summary>
        ///     Gets the value at offset. The offset does not have to be exact beginning offset of value as long as the value would
        ///     conflict with this offset it returns the result. Check result's offset
    ...
    public sealed class MemoryStructField
    {
        ...
        public bool TryToPointer(ref IntPtr value)
        {
            ...
            {
                var v = BitConverter.ToInt32(this.Data, 0);
                value = new IntPtr(v);
            }
