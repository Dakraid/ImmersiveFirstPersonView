namespace NetScriptFramework.Tools
{
    ...
    public sealed class LogFile : IDisposable
    {
        ...
        /// </summary>
        public void Close() => this.CloseFile();

        /// <summary>
        ///     Appends the specified text to log file without writing a newline at the end. This will re-open the file if it is
        ///     not opened!
        /// </summary>
        ...
        /// <summary>
        ///     Appends the specified text to log file and writes a newline at the end. This will re-open the file if it is not
        ///     opened!
        /// </summary>
        /// <param name="text">The text to append.</param>
    ...
    public enum LogFileFlags : uint
    {
        ...
        /// <summary>
        ///     Automatically flush to file after each write. This can be slower but ensures that all data is written immediately,
        ///     when
