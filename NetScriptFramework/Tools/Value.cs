...
#region Value class
    ...
    #region Constructors
        ...
        public Value(byte[] data, int index, int length, ref int size)
        {
            ...
            switch ( (TypeCode)data[index] )
            {
                ...
                default : throw new ArgumentException("data", string.Format("Invalid type code {0} found!", (TypeCode)data[index]));
            }
        }
    ...
    #region Value members
        ...
        public byte[] ToArray()
        {
            ...
            {
                case TypeCode.Boolean : return new[] { (byte)this.CurrentType, (bool)this.CurrentValue ? (byte)1 : (byte)0 };
                case TypeCode.SByte :   return new[] { (byte)this.CurrentType, (byte)this.CurrentValue };
                case TypeCode.Byte :    return new[] { (byte)this.CurrentType, (byte)this.CurrentValue };
                case TypeCode.Char :    return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes((char)this.CurrentValue)).ToArray();
                case TypeCode.Int16 :   return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes((short)this.CurrentValue)).ToArray();
                case TypeCode.UInt16 :  return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes((ushort)this.CurrentValue)).ToArray();
                case TypeCode.Int32 :   return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes((int)this.CurrentValue)).ToArray();
                case TypeCode.UInt32 :  return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes((uint)this.CurrentValue)).ToArray();
                case TypeCode.Int64 :   return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes((long)this.CurrentValue)).ToArray();
                case TypeCode.UInt64 :  return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes((ulong)this.CurrentValue)).ToArray();
                case TypeCode.Single :  return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes((float)this.CurrentValue)).ToArray();
                case TypeCode.Double :  return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes((double)this.CurrentValue)).ToArray();

                case TypeCode.Decimal :
                {
                    var bits = decimal.GetBits((decimal)this.CurrentValue);
                    return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes(bits[0])).Concat(BitConverter.GetBytes(bits[1])).Concat(BitConverter.GetBytes(bits[2])).Concat(BitConverter.GetBytes(bits[3])).ToArray();
                }

                case TypeCode.String :
                {
                    var encoded = Encoding.Unicode.GetBytes((string)this.CurrentValue);
                    return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes(encoded.Length)).Concat(encoded).ToArray();
                }

                case TypeCode.DateTime : return new[] { (byte)this.CurrentType }.Concat(BitConverter.GetBytes(((DateTime)this.CurrentValue).Ticks)).ToArray();
    ...
    #region IConvertible members
        ...
        public object ToType(Type conversionType, IFormatProvider provider)
        {
            ...
            {
                case TypeCode.Boolean :  return this.ToBoolean(provider);
                ...
                case TypeCode.Decimal :  return this.ToDecimal(provider);
                case TypeCode.String :   return this.ToString(provider);
                case TypeCode.DateTime : return this.ToDateTime(provider);
        ...
        public bool ToBoolean(IFormatProvider provider = null)
        {
            ...
            switch ( this._tryToBool(ref result, ref result2) )
            {
                ...
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to boolean!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to boolean!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to boolean!", this)); // Overflow.
        ...
        public byte ToByte(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                  // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to byte!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to byte!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to byte!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public sbyte ToSByte(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                         // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to signed byte!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to signed byte!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to signed byte!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public char ToChar(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                       // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to character!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to character!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to character!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public short ToInt16(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                   // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to short!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to short!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to short!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public ushort ToUInt16(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                            // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to unsigned short!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to unsigned short!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to unsigned short!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public int ToInt32(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                     // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to integer!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to integer!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to integer!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public uint ToUInt32(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                              // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to unsigned integer!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to unsigned integer!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to unsigned integer!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public long ToInt64(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                  // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to long!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to long!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to long!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public ulong ToUInt64(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                           // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to unsigned long!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to unsigned long!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to unsigned long!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public float ToSingle(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                    // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to single!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to single!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to single!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public double ToDouble(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                    // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to double!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to double!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to double!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public decimal ToDecimal(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                     // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to decimal!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to decimal!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to decimal!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
        ...
        public DateTime ToDateTime(IFormatProvider provider = null)
        {
            ...
            {
                case 0 :  return result;                                                                                                       // No errors.
                case 1 :  throw new FormatException(string.Format("Argument '{0}' is not a valid format for conversion to date time!", this)); // Bad format.
                case 2 :  throw new InvalidCastException(string.Format("Argument '{0}' is not valid for casting to date time!", this));        // Bad cast.
                case 3 :  throw new InvalidOperationException();
                case 4 :  throw new OverflowException(string.Format("Argument '{0}' caused an overflow when casting to date time!", this)); // Overflow.
                default : throw new NotImplementedException();
            }
        }
    ...
    #region Internal conversion
        ...
        private int _tryToDateTime(ref DateTime result, ref DateTime result2)
        {
            ...
            switch ( this.CurrentType )
            {
                ...
                case TypeCode.UInt32 :
                    result  = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc) + new TimeSpan(10000000 * (long)(uint)this.CurrentValue);
                    result2 = result;
                    return 0;

                case TypeCode.Int64 : return this._tryToDateTime((long)this.CurrentValue, ref result, ref result2);
    ...
    #region Static members
        ...
        public static Value Parse(string text, TypeCode type)
        {
            ...
            switch ( type )
            {
                case TypeCode.Boolean :  return new Value(v.ToBoolean());
                case TypeCode.SByte :    return new Value(v.ToSByte());
                case TypeCode.Byte :     return new Value(v.ToByte());
                case TypeCode.Char :     return new Value(v.ToChar());
                case TypeCode.Int16 :    return new Value(v.ToInt16());
                case TypeCode.UInt16 :   return new Value(v.ToUInt16());
                case TypeCode.Int32 :    return new Value(v.ToInt32());
                case TypeCode.UInt32 :   return new Value(v.ToUInt32());
                case TypeCode.Int64 :    return new Value(v.ToInt64());
                case TypeCode.UInt64 :   return new Value(v.ToUInt64());
                case TypeCode.Single :   return new Value(v.ToSingle());
                case TypeCode.Double :   return new Value(v.ToDouble());
                case TypeCode.Decimal :  return new Value(v.ToDecimal());
                case TypeCode.String :   return new Value(v.ToString());
                case TypeCode.DateTime : return new Value(v.ToDateTime());
