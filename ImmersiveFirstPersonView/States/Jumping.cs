namespace IFPV.States
{
    ...
    internal class Jumping : CameraState
    {
        ...
        internal override void OnEntering(CameraUpdate update)
        {
            ...
            update.Values.StabilizeIgnoreOffsetX.AddModifier(
                this, CameraValueModifier.ModifierTypes.SetIfPreviousIsLowerThanThis, 25.0, true, 500);
            update.Values.StabilizeIgnoreOffsetY.AddModifier(
                this, CameraValueModifier.ModifierTypes.SetIfPreviousIsLowerThanThis, 37.0, true, 700);
        }
    }
}
