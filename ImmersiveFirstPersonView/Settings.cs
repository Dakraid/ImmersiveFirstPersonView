...
namespace IFPV
{
    ...
    public sealed class Settings
    {
        ...
        [ConfigValue("ReloadSettings", "Reload", "The hotkey to reload IFPV's config. See https://docs.microsoft.com/en-us/windows/desktop/inputdev/virtual-key-codes for a list of all keycodes. For example 0x61 is numpad 1. This is optional and setting 0 disables the hotkey.", ConfigEntryFlags.PreferHex)]
        public int ReloadSettings
        {
            get;
            set;
        } = 0;
