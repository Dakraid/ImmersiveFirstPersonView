...
namespace IFPV.Values
{
    ...
    {
        internal HideHead() : base(null, 0.0, 1.0) { Flags |= CameraValueFlags.NoTween; }
    }

    internal sealed class HideHead2 : CameraValueSimple
    {
        internal HideHead2() : base(null, 0.0, 1.0) { Flags |= CameraValueFlags.NoTween; }
    }
    ...
    {
        internal HideArms() : base(null, 0.0, 1.0) { Flags |= CameraValueFlags.NoTween; }
    }

    internal sealed class Show1stPersonArms : CameraValueSimple
    {
        internal Show1stPersonArms() : base(null, 0.0, 1.0) { Flags |= CameraValueFlags.NoTween; }
    }
    ...
    {
        internal BlockPlayerFadeOut() : base(null, 0.0, 1.0) { Flags |= CameraValueFlags.NoTween; }
    }

    internal sealed class SkeletonMode : CameraValueSimple
    {
        internal SkeletonMode() : base(null, -1.0, 1.0) { Flags |= CameraValueFlags.NoTween; }
    }
}
