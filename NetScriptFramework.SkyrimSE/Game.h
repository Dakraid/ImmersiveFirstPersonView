...
public:
	...
	SkyrimSEGame()
		: Game()
	{
		this->AppVersion = gcnew System::Collections::Generic::List<int
		>(4);
		this->AppVersion->AddRange(
			NetScriptFramework::Memory::GetMainModuleVersion());
	}
	...
	/// The version of game.
	/// </value>
	property System::Collections::Generic::IReadOnlyList<System::Int32> ^
	GameVersion
	{
		System::Collections::Generic::IReadOnlyList<System::Int32> ^
		__clrcall get() override
		{
